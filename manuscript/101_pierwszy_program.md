...
{width: 80%}
![Програма Python, що працює в командному рядку.](101_cmd_examplehello.png)
...
![Використання IDLE.](resources/101_IDLE.png)
...
```python
print("Текст 1") <!—можливо, тут не потрібне перенесення рядка? (być może tutaj kod nie powinien być rozdzielony na dwie linijki?) -->
print("Текст 2")
