# Вивчення програмування на телефоні <!-- у цьому розділі практично дослівно копіюються куски тексту з файлу 502. так треба? (w tym rozdziale są prawie dosłowne fragmenty z pliku 502. czy tak ma być?) -->
